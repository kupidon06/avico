...
class Advertisement(models.Model):
    ...
    image = models.ImageField(upload_to='advertisements/', null=True, blank=True, verbose_name="Advertisement Image")
    background_color = models.CharField(max_length=7, null=True, blank=True, verbose_name="Background Color")  
    button_text = models.CharField(max_length=100, null=True, blank=True, verbose_name="Button Text")
    button_link = models.URLField(null=True, blank=True, verbose_name="Button Link")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created At")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated At")

    def __str__(self):
        return self.title or "Unnamed Advertisement"
