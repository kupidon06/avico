...
class OrderItem(models.Model):
    ...
    product_unit = models.ForeignKey('products.ProductUnit', on_delete=models.CASCADE, related_name='order_items', blank=True)
    quantity = models.PositiveIntegerField(default=1)
    batches = models.ManyToManyField('orders.BatchAllocation', related_name='order_items')
...
class BatchAllocation(models.Model):
    ...
    order_item = models.ForeignKey('orders.OrderItem', related_name='batch_allocations', on_delete=models.CASCADE)
...
class DeliveryLocation(models.Model):
    """Modèle pour stocker les lieux de livraison d'un utilisateur."""
    user = models.ForeignKey('users.User', on_delete=models.CASCADE, related_name="delivery_locations")
    name = models.CharField(max_length=255, help_text="Nom du lieu (Ex : Maison, Bureau, etc.)")
